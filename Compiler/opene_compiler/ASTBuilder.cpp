...
namespace opene {
    ...
    antlrcpp::Any ASTBuilder::visitControlStatement(openeLangParser::ControlStatementContext *context) {
        return NodeWarp(GetFromCtxIfExist<ControlStmtPtr>(context->control_statement()));
    }

    antlrcpp::Any ASTBuilder::visitContinueStmt(openeLangParser::ContinueStmtContext *context) {
        ContinueStmtPtr continue_stmt = CreateNode<ContinueStmt>(context->getStart(), context->getStop());
        return NodeWarp(continue_stmt);
    }

    antlrcpp::Any ASTBuilder::visitBreakStmt(openeLangParser::BreakStmtContext *context) {
        BreakStmtPtr break_stmt = CreateNode<BreakStmt>(context->getStart(), context->getStop());
        return NodeWarp(break_stmt);
    }

    antlrcpp::Any ASTBuilder::visitReturnStmt(openeLangParser::ReturnStmtContext *context) {
    ...
    antlrcpp::Any ASTBuilder::visitExitStmt(openeLangParser::ExitStmtContext *context) {
