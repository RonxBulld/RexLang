...
public:
  ...
  virtual void enterMember_vari_decl(openeLangParser::Member_vari_declContext * /*ctx*/) override { }
  virtual void exitMember_vari_decl(openeLangParser::Member_vari_declContext * /*ctx*/) override { }

  virtual void enterFile_vari_decl(openeLangParser::File_vari_declContext * /*ctx*/) override { }
  virtual void exitFile_vari_decl(openeLangParser::File_vari_declContext * /*ctx*/) override { }
  ...
  virtual void enterControlStatement(openeLangParser::ControlStatementContext * /*ctx*/) override { }
  virtual void exitControlStatement(openeLangParser::ControlStatementContext * /*ctx*/) override { }
  ...
  virtual void enterContinueStmt(openeLangParser::ContinueStmtContext * /*ctx*/) override { }
  virtual void exitContinueStmt(openeLangParser::ContinueStmtContext * /*ctx*/) override { }

  virtual void enterBreakStmt(openeLangParser::BreakStmtContext * /*ctx*/) override { }
  virtual void exitBreakStmt(openeLangParser::BreakStmtContext * /*ctx*/) override { }

  virtual void enterReturnStmt(openeLangParser::ReturnStmtContext * /*ctx*/) override { }
  virtual void exitReturnStmt(openeLangParser::ReturnStmtContext * /*ctx*/) override { }

  virtual void enterExitStmt(openeLangParser::ExitStmtContext * /*ctx*/) override { }
  virtual void exitExitStmt(openeLangParser::ExitStmtContext * /*ctx*/) override { }
