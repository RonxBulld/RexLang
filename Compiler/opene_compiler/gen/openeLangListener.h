...
public:
  ...
  virtual void enterParameter_decl_list(openeLangParser::Parameter_decl_listContext *ctx) = 0;
  virtual void exitParameter_decl_list(openeLangParser::Parameter_decl_listContext *ctx) = 0;
  ...
  virtual void enterVari_parameter_decl(openeLangParser::Vari_parameter_declContext *ctx) = 0;
  virtual void exitVari_parameter_decl(openeLangParser::Vari_parameter_declContext *ctx) = 0;
  ...
  virtual void enterControlStatement(openeLangParser::ControlStatementContext *ctx) = 0;
  virtual void exitControlStatement(openeLangParser::ControlStatementContext *ctx) = 0;
  ...
  virtual void enterContinueStmt(openeLangParser::ContinueStmtContext *ctx) = 0;
  virtual void exitContinueStmt(openeLangParser::ContinueStmtContext *ctx) = 0;

  virtual void enterBreakStmt(openeLangParser::BreakStmtContext *ctx) = 0;
  virtual void exitBreakStmt(openeLangParser::BreakStmtContext *ctx) = 0;

  virtual void enterReturnStmt(openeLangParser::ReturnStmtContext *ctx) = 0;
  virtual void exitReturnStmt(openeLangParser::ReturnStmtContext *ctx) = 0;

  virtual void enterExitStmt(openeLangParser::ExitStmtContext *ctx) = 0;
  virtual void exitExitStmt(openeLangParser::ExitStmtContext *ctx) = 0;
