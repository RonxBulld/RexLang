...
openeLangParser::Vari_parameter_declContext* openeLangParser::vari_parameter_decl() {
  ...
  try {
    ...
    match(openeLangParser::T__13);
    setState(427);
    dynamic_cast<Vari_parameter_declContext *>(_localctx)->name = match(openeLangParser::T__14);
    setState(428);
    match(openeLangParser::T__2);
    setState(429);
    ...
    while (alt != 2 && alt != atn::ATN::INVALID_ALT_NUMBER) {
      if (alt == 1) {
        ...
        if (((((_la - 16) & ~ 0x3fULL) == 0) &&
          ...
          | (1ULL << (openeLangParser::T__16 - 16))
          | (1ULL << (openeLangParser::T__21 - 16))
          | (1ULL << (openeLangParser::T__23 - 16))
          | (1ULL << (openeLangParser::T__25 - 16))
          | (1ULL << (openeLangParser::T__27 - 16))
          | (1ULL << (openeLangParser::T__29 - 16))
          | (1ULL << (openeLangParser::T__32 - 16))
          | (1ULL << (openeLangParser::T__34 - 16))
          | (1ULL << (openeLangParser::T__35 - 16))
          | (1ULL << (openeLangParser::T__36 - 16))
          | (1ULL << (openeLangParser::T__37 - 16))
          | (1ULL << (openeLangParser::T__39 - 16))
          | (1ULL << (openeLangParser::T__41 - 16))
          | (1ULL << (openeLangParser::T__52 - 16))
          | (1ULL << (openeLangParser::T__53 - 16))
          | (1ULL << (openeLangParser::T__54 - 16))
          | (1ULL << (openeLangParser::T__55 - 16))
...
openeLangParser::Switch_statementContext* openeLangParser::switch_statement() {
  ...
  try {
    ...
    _errHandler->sync(this);
    _la = _input->LA(1);
    while (_la == openeLangParser::T__18) {
      setState(471);
  ...
  try {
    ...
    switch (_input->LA(1)) {
      ...
      case openeLangParser::T__36: {
        ...
        _la = _input->LA(1);
        if (((((_la - 17) & ~ 0x3fULL) == 0) &&
          ((1ULL << (_la - 17)) & ((1ULL << (openeLangParser::T__16 - 17))
          | (1ULL << (openeLangParser::T__39 - 17))
          | (1ULL << (openeLangParser::T__41 - 17))
          | (1ULL << (openeLangParser::T__52 - 17))
          | (1ULL << (openeLangParser::T__53 - 17))
          | (1ULL << (openeLangParser::T__54 - 17))
          | (1ULL << (openeLangParser::T__55 - 17))
          | (1ULL << (openeLangParser::K_SUB_OPT - 17))
          | (1ULL << (openeLangParser::INTEGER_LITERAL - 17))
          | (1ULL << (openeLangParser::FLOAT_LITERAL - 17))
          | (1ULL << (openeLangParser::IDENTIFIER - 17))
          | (1ULL << (openeLangParser::STRING_LITERAL - 17)))) != 0)) {
          setState(570);
  ...
  try {
    ...
    switch (_input->LA(1)) {
      case openeLangParser::T__54: {
        ...
        enterOuterAlt(_localctx, 1);
        setState(777);
        dynamic_cast<BoolValueTrueContext *>(_localctx)->bval = match(openeLangParser::T__54);
        break;
      }
      ...
      case openeLangParser::T__55: {
        ...
        enterOuterAlt(_localctx, 2);
        setState(778);
        dynamic_cast<BoolValueFalseContext *>(_localctx)->bval = match(openeLangParser::T__55);
        break;
      }
