...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitMember_vari_decl(openeLangParser::Member_vari_declContext *context) = 0;

    virtual antlrcpp::Any visitFile_vari_decl(openeLangParser::File_vari_declContext *context) = 0;
    ...
    virtual antlrcpp::Any visitControlStatement(openeLangParser::ControlStatementContext *context) = 0;
    ...
    virtual antlrcpp::Any visitContinueStmt(openeLangParser::ContinueStmtContext *context) = 0;

    virtual antlrcpp::Any visitBreakStmt(openeLangParser::BreakStmtContext *context) = 0;

    virtual antlrcpp::Any visitReturnStmt(openeLangParser::ReturnStmtContext *context) = 0;

    virtual antlrcpp::Any visitExitStmt(openeLangParser::ExitStmtContext *context) = 0;
