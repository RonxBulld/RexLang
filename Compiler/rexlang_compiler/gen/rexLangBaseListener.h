...
public:
  ...
  virtual void enterApi_define_file(rexLangParser::Api_define_fileContext * /*ctx*/) override { }
  virtual void exitApi_define_file(rexLangParser::Api_define_fileContext * /*ctx*/) override { }
